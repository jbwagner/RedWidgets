...
class Red_Widgets_Callout extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'red-widgets-callout';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'RedWidgets Callout', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'Custom callout widget from COCG.', $this->get_widget_slug() )
			)
		);
	...
	public function widget_textdomain() {
		...
		// TODO be sure to change 'red-widgets-callout' to the name of *your* plugin
